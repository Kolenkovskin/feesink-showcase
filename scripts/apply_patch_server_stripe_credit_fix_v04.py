# scripts/apply_patch_server_stripe_credit_fix_v04.py
# FEESINK-APPLY-PATCH-SERVER-STRIPE-CREDIT v2026.01.05-04
...
VERSION = "FEESINK-APPLY-PATCH-SERVER-STRIPE-CREDIT v2026.01.05-04"
...
def main() -> int:
    ...
    # ------------------------------------------------------------------
    # PATCH 1: Remove early return on dedup response
    # We replace the FIRST occurrence of:
    #   return _json_response(200, {"ok": True, "dedup": True})
    # with a comment so the handler continues to attempt credit.
    # ------------------------------------------------------------------
...
""",
    ...
    print("  - stripe_TopUp_constructor_fixed:", n_stripe_topup == 1)
